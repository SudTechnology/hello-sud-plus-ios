...
- (void)dtAddViews {
    ...
    self.voiceBtnState = QSVoiceBtnStateTypeNormal;
}
...
- (void)setVoiceBtnState:(QSVoiceBtnStateType)voiceBtnState {
    _voiceBtnState = voiceBtnState;
    switch (voiceBtnState) {
        case QSVoiceBtnStateTypeUpMic:
            /// 与等待开启一致
        case QSVoiceBtnStateTypeWaitOpen:
            ...
            break;
        case QSVoiceBtnStateTypeOnVoice:

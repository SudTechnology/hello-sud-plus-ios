...
// 更新房间号
- (void)updateRoomNum:(NSString *)roomNum {
    self.roomNumLabel.text = [NSString stringWithFormat: @"%@ %@", @"房间ID:", roomNum];
}
...
- (void)dtUpdateUI {
    self.onlineLabel.text = [NSString stringWithFormat:@"%d",100];
}

...
- (void)hs_configureTextView
{
    ...
    [self hs_addTextViewNotificationObservers];
...
- (void)dealloc
{
    [self hs_removeTextViewNotificationObservers];
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([self.text length] == 0 && self.placeHolder) {
        ...
        [self.placeHolder drawInRect:UIEdgeInsetsInsetRect(rect, self.placeHolderInsets)
                      withAttributes:[self hs_placeholderTextAttributes]];
    }
}

#pragma mark - Notifications

- (void)hs_addTextViewNotificationObservers
{
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(hs_didReceiveTextViewNotification:)
...
- (void)hs_removeTextViewNotificationObservers
{
...
- (void)hs_didReceiveTextViewNotification:(NSNotification *)notification
{
    [self setNeedsDisplay];
...
- (NSDictionary *)hs_placeholderTextAttributes
{

...
/// @param extendedData 扩展信息
/// @param roomID 流ID
- (void)onPublisherStateUpdate:(HSAudioEnginePublisherSateType)state errorCode:(NSInteger)errorCode extendedData:(NSDictionary<NSString *, NSObject*>*)extendedData streamID:(NSString *)roomID;

/// 播放状态更新 拉取，播放请求，播放中
/// @param state 拉取，播放请求，播放中
/// @param extendedData 扩展信息
/// @param roomID 流ID
- (void)onPlayerStateUpdate:(HSAudioEnginePlayerStateType)state extendedData:(NSDictionary<NSString *, NSObject*>*)extendedData streamID:(NSString *)roomID;

/// SDK网络状态变化
/// @param mode mode description
- (void)onNetworkModeChanged:(HSAudioEngineNetworkStateType)mode;
...
/// @param roomID 房间ID
- (void)onRoomStateUpdate:(HSAudioEngineRoomState)state errorCode:(int)errorCode extendedData:(nullable NSDictionary *)extendedData roomID:(NSString *)roomID;

...
- (void)configData {
    ...
    for (NSUInteger i = 0; i < arr.count; ++i) {
        ...
        /// 是否选中
        if (([name isEqualToString:kRtcNameZego] && [AppService.shared.rtcType isEqualToString:@"zego"]) ||
                ([name isEqualToString:kRtcNameAgora] && [AppService.shared.rtcType isEqualToString:@"agora"])) {
            m.isSlect = YES;
        }

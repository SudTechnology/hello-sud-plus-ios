...
@interface HSSweetPromptView ()
@property (nonatomic, strong) YYLabel *contentLabel;
@property (nonatomic, strong) UIButton *agreeBtn;
@property (nonatomic, strong) UIButton *exitBtn;
@end

@implementation HSSweetPromptView
...
- (UIButton *)exitBtn {
    if (!_exitBtn) {
        ...
        [_agreeBtn setTitleColor:[UIColor colorWithHexString:@"#666666" alpha:1] forState:UIControlStateNormal];
        _agreeBtn.titleLabel.font = [UIFont systemFontOfSize:14 weight:UIFontWeightMedium];
        [_agreeBtn addTarget:self action:@selector(onSureItemEvent:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _agreeBtn;

...
@interface ForeignWalletSelectPopView () <UITableViewDelegate, UITableViewDataSource>
...
@implementation ForeignWalletSelectPopView
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[ForeignWalletSelectCell class] forCellReuseIdentifier:@"ForeignWalletSelectCell"];
    }
    return _tableView;
}

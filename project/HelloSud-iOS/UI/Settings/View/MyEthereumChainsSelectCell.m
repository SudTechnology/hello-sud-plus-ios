...
@interface MyEthereumChainsSelectCell ()
...
@implementation MyEthereumChainsSelectCell
...
- (void)dtUpdateUI {
    [super dtUpdateUI];
    if (![self.model isKindOfClass:MyEthereumChainsCellModel.class]) {
        return;
    }
    MyEthereumChainsCellModel *m = (MyEthereumChainsCellModel *) self.model;

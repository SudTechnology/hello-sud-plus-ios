...
@interface SudNFTQsNFTDetailViewController ()
...
@implementation SudNFTQsNFTDetailViewController
...
- (void)onWearBtnClick:(UIButton *)sender {
    ...
    } else if (SudNFTQSAppPreferences.shared.isBindForeignWallet) {
        [self wearNFT:sender];
    }
}
...
- (void)dtUpdateUI {
    ...
    BOOL isCNBind = SudNFTQSAppPreferences.shared.isBindCNWallet;

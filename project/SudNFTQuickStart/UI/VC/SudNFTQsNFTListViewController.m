...
#import "SudNFTQsNFTColCell.h"
#import "SudNFTQsNFTDetailViewController.h"


@interface SudNFTQsNFTListViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property(nonatomic, strong) UICollectionView *collectionView;
@property(nonatomic, strong) NSMutableArray<SudNFTQSNFTListCellModel *> *dataList;
@property(nonatomic, strong) NSString *pageKey;
@property(nonatomic, assign) NSInteger page;
@end

@implementation SudNFTQsNFTListViewController
...
- (void)resortNFTList {
    ...
    for (SudNFTQSNFTListCellModel *m in temp) {
...
- (void)requestNFTListData:(BOOL)isMore {
    ...
    [SudNFT getNFTList:paramModel listener:^(NSInteger errCode, NSString *errMsg, SudNFTGetNFTListModel *nftListModel) {
        ...
        for (SudNFTInfoModel *m in nftListModel.nftList) {
            SudNFTQSNFTListCellModel *cellModel = [[SudNFTQSNFTListCellModel alloc] init];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    SudNFTQsNFTColCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"MyNFTColCell" forIndexPath:indexPath];
    SudNFTQsNFTColCell *c = (SudNFTQsNFTColCell *) cell;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SudNFTQsNFTDetailViewController *vc = [[SudNFTQsNFTDetailViewController alloc] init];
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[SudNFTQsNFTColCell class] forCellWithReuseIdentifier:@"MyNFTColCell"];
    }

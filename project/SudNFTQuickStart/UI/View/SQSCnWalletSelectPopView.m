...
#import "SQSCnWalletSelectCell.h"
#import "SQSCnEthereumChainsCellModel.h"

@interface SQSCnWalletSelectPopView () <UITableViewDelegate, UITableViewDataSource>
...
@implementation SQSCnWalletSelectPopView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SQSCnWalletSelectCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CNWalletSelectCell"];
    WeakSelf
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[SQSCnWalletSelectCell class] forCellReuseIdentifier:@"CNWalletSelectCell"];
    }
    return _tableView;
}

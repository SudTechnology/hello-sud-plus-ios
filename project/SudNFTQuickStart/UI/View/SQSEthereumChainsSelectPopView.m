...
#import "SQSEthereumChainsSelectCell.h"
#import "SQSCnEthereumChainsCellModel.h"

@interface SQSEthereumChainsSelectPopView () <UITableViewDelegate, UITableViewDataSource>
@property(nonatomic, strong) UILabel *titleLabel;
@property(nonatomic, strong) UITableView *tableView;
@property(nonatomic, strong) UIButton *sureBtn;
@property(nonatomic, strong) NSArray<SQSCnEthereumChainsCellModel *> *dataList;
@end

@implementation SQSEthereumChainsSelectPopView
...
- (void)updateChains:(NSArray<SudNFTChainInfoModel *> *)chains {
    ...
    for (SudNFTChainInfoModel *m in chains) {
        SQSCnEthereumChainsCellModel *cellModel = [[SQSCnEthereumChainsCellModel alloc] init];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[SQSEthereumChainsSelectCell class] forCellReuseIdentifier:@"MyEthereumChainsSelectCell"];
    }
    return _tableView;
}

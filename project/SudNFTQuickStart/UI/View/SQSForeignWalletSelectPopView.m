...
#import "SQSForeignWalletSelectPopView.h"
#import "SQSForeignWalletSelectCell.h"
#import "SQSCnEthereumChainsCellModel.h"

@interface SQSForeignWalletSelectPopView () <UITableViewDelegate, UITableViewDataSource>
...
@implementation SQSForeignWalletSelectPopView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SQSForeignWalletSelectCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ForeignWalletSelectCell"];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[SQSForeignWalletSelectCell class] forCellReuseIdentifier:@"ForeignWalletSelectCell"];
    }
    return _tableView;
}

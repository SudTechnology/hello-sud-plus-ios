...
#import "SudNFTQsCnWalletSelectCell.h"
#import "SudNFTQsCnEthereumChainsCellModel.h"

@interface SudNFTQsCnWalletSelectPopView () <UITableViewDelegate, UITableViewDataSource>
...
@implementation SudNFTQsCnWalletSelectPopView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SudNFTQsCnWalletSelectCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CNWalletSelectCell"];
    WeakSelf
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[SudNFTQsCnWalletSelectCell class] forCellReuseIdentifier:@"CNWalletSelectCell"];
    }
    return _tableView;
}

...
@interface SudNFTQsCnWalletSwitchCell ()
...
@implementation SudNFTQsCnWalletSwitchCell
...
- (void)dtUpdateUI {
    [super dtUpdateUI];
    if (![self.model isKindOfClass:SudNFTQsCnWalletSwitchCellModel.class]) {
        return;
    }
    SudNFTQsCnWalletSwitchCellModel *m = (SudNFTQsCnWalletSwitchCellModel *) self.model;

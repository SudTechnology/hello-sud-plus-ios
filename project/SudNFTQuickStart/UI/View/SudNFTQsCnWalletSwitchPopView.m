...
#import "SudNFTQsCnWalletSwitchCell.h"
#import "SudNFTQsCnWalletSwitchCellModel.h"

@interface SudNFTQsCnWalletSwitchPopView () <UITableViewDelegate, UITableViewDataSource>
@property(nonatomic, strong) UILabel *titleLabel;
@property(nonatomic, strong) UITableView *tableView;
@property(nonatomic, strong) UIButton *sureBtn;
@property(nonatomic, strong) NSArray<SudNFTQsCnWalletSwitchCellModel *> *dataList;
@end

@implementation SudNFTQsCnWalletSwitchPopView
...
- (void)updateBindWalletList:(NSArray<SudNFTWalletInfoModel *> *)bindWalletList {
    ...
    for (SudNFTWalletInfoModel *m in bindWalletList) {
        ...
        SudNFTQsCnWalletSwitchCellModel *cellModel = [[SudNFTQsCnWalletSwitchCellModel alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SudNFTQsCnWalletSwitchCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MyCNWalletSwitchCell"];
    SudNFTQsCnWalletSwitchCellModel *m = self.dataList[indexPath.row];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[SudNFTQsCnWalletSwitchCell class] forCellReuseIdentifier:@"MyCNWalletSwitchCell"];
    }
    return _tableView;
}

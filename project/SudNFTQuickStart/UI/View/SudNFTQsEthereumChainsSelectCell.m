...
@interface SudNFTQsEthereumChainsSelectCell ()
...
@implementation SudNFTQsEthereumChainsSelectCell
...
- (void)dtUpdateUI {
    [super dtUpdateUI];
    if (![self.model isKindOfClass:SudNFTQsCnEthereumChainsCellModel.class]) {
        return;
    }
    SudNFTQsCnEthereumChainsCellModel *m = (SudNFTQsCnEthereumChainsCellModel *) self.model;

...
#import "SudNFTQsEthereumChainsSelectCell.h"
#import "SudNFTQsCnEthereumChainsCellModel.h"

@interface SudNFTQsEthereumChainsSelectPopView () <UITableViewDelegate, UITableViewDataSource>
@property(nonatomic, strong) UILabel *titleLabel;
@property(nonatomic, strong) UITableView *tableView;
@property(nonatomic, strong) UIButton *sureBtn;
@property(nonatomic, strong) NSArray<SudNFTQsCnEthereumChainsCellModel *> *dataList;
@end

@implementation SudNFTQsEthereumChainsSelectPopView
...
- (void)updateChains:(NSArray<SudNFTChainInfoModel *> *)chains {
    ...
    for (SudNFTChainInfoModel *m in chains) {
        SudNFTQsCnEthereumChainsCellModel *cellModel = [[SudNFTQsCnEthereumChainsCellModel alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SudNFTQsEthereumChainsSelectCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MyEthereumChainsSelectCell"];
    SudNFTQsCnEthereumChainsCellModel *m = self.dataList[indexPath.row];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[SudNFTQsEthereumChainsSelectCell class] forCellReuseIdentifier:@"MyEthereumChainsSelectCell"];
    }
    return _tableView;
}

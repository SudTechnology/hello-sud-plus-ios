...
@property(nonatomic, strong) SudNFTQsBindWalletView *bindView;
@property(nonatomic, strong) SudNFTQsNFTView *myNFTView;

@end

@implementation SudNFTQsHeaderView
...
- (SudNFTQsBindWalletView *)bindView {
    if (!_bindView) {
        _bindView = [[SudNFTQsBindWalletView alloc] init];
    }
    return _bindView;
}

- (SudNFTQsNFTView *)myNFTView {
    if (!_myNFTView) {
        _myNFTView = [[SudNFTQsNFTView alloc] init];
    }
    return _myNFTView;
}
...
- (UIButton *)deleteBtn {
    if (!_deleteBtn) {
        ...
        _deleteBtn.showsTouchWhenHighlighted = NO;

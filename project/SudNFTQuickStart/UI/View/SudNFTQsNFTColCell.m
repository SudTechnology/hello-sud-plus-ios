...
@implementation SudNFTQsNFTColCell
...
- (void)dtUpdateUI {
    [super dtUpdateUI];
    if (![self.model isKindOfClass:SudNFTQSNFTListCellModel.class]) {
        return;
    }
    SudNFTQSNFTListCellModel *m = (SudNFTQSNFTListCellModel *) self.model;
    WeakSelf

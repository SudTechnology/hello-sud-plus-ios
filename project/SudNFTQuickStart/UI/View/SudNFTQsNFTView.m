...
#import "SudNFTQsNFTView.h"
#import "SudNFTQsNFTListViewController.h"
#import "UIImageView+AFNetworking.h"
#import "SudNFTQsSelectEtherChainsView.h"
#import "SudNFTQsEthereumChainsSelectPopView.h"
#import "SudNFTQSNFTListCellModel.h"
#import "SudNFTQsCnWalletSwitchPopView.h"

@interface SudNFTQsNFTView ()
@property(nonatomic, strong) SudNFTQsSelectEtherChainsView *chainsView;
...
@property(nonatomic, strong) NSArray<SudNFTQSNFTListCellModel *> *nftCellModelList;
...
@implementation SudNFTQsNFTView
...
- (void)updateShowInfo {
    ...
    for (int i = 0; i < self.iconImageViewList.count; ++i) {
        ...
        if (self.nftCellModelList.count > i) {
            SudNFTQSNFTListCellModel *cellModel = self.nftCellModelList[i];
            [self showLoadAnimate:iv];
...
- (void)onTapChainsView:(id)tap {
    ...
    if (zoneType == 1) {
        // 国内
        SudNFTQsCnWalletSwitchPopView *v = [[SudNFTQsCnWalletSwitchPopView alloc] init];
    ...
    /// 国外选择链
    SudNFTQsEthereumChainsSelectPopView *v = [[SudNFTQsEthereumChainsSelectPopView alloc] init];
...
- (void)onTapMoreView:(id)tap {
    /// 点击更多
    SudNFTQsNFTListViewController *vc = [[SudNFTQsNFTListViewController alloc] init];
...
- (SudNFTQsSelectEtherChainsView *)chainsView {
    if (!_chainsView) {
        _chainsView = [[SudNFTQsSelectEtherChainsView alloc] init];

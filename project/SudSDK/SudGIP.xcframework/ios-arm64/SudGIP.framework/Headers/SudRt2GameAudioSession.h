...
@protocol SudRt2GameQueryAudioOptionsHandle <NSObject>
...
- (void)setGameQueryAudioOptionsListener:(nullable id<SudRt2GameQueryAudioOptionsListener>)listener;
